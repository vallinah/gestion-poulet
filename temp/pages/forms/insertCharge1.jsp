...
<% 
  ...
  List<TypeCharge> typeCharges = (List<TypeCharge>) request.getAttribute("typeCharge");

  // Vérification des données
  if (chargeAnalytiques == null || chargeAnalytiques.isEmpty()) {
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" action="traitementCharge" method="post" enctype="multipart/form-data">
                    <p class="card-description">First</p>
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Unite d'oeuvre</label>
                            <div class="col-sm-9">
                              <input type="text" name="unite_oeuvre" class="form-control" />
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Charge Analytique</label>
                          <div class="col-sm-9">
                    ...
                    <p class="card-description">Etapes</p>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Demarage</label>
                          <div class="col-sm-9">
                            <input type="number" name="pourcentage_demarrage" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
